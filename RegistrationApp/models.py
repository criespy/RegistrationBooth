...
def get_qr_code_upload_path(instance, filename):
    ...
    return os.path.join('qr_codes', f'qr_code_{instance.nama}.png')
...
class Tamu(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        if self.qr_code:
            file_path = os.path.join(settings.MEDIA_ROOT, self.qr_code.name)
        ...
        file_name = f'qr_code_{self.instansi}_{self.nama}.png'
